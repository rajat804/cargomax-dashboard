...
export default function CashAndBankMRRegister() {
  ...
  const [mailSubject, setMailSubject] = useState("Cash and Bank MR Register Report");
  const [mailBody, setMailBody] = useState("Dear Sir/Madam,\n\nPlease find attached the Cash and Bank MR Register Report.\n\nRegards,\nGolden Roadways");

  const handleGenerateReport = () => {
    alert("Cash & Bank MR Register Report Generated Successfully!");
  };
  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <div className="border-b pb-4">
        <h1 className="text-2xl font-bold text-primary">CASH AND BANK MR REGISTER REPORT</h1>
