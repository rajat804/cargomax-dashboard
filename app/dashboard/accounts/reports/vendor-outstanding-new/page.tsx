...
// ==================== TYPE DEFINITIONS ====================
interface VendorOutstandingNew {
  id: number;
  sNo: number;
  vendorName: string;
  vendorCode: string;
...
// ==================== MOCK DATA ====================
const mockVendorOutstandingNewData: VendorOutstandingNew[] = [
  { id: 1, sNo: 1, vendorName: "Sharma Suppliers", vendorCode: "VEN001", invoiceNo: "INV-101", invoiceDate: "15-03-2026", dueDate: "15-04-2026", billAmount: 50000, paidAmount: 25000, outstandingAmount: 25000, age0to30: 0, age31to60: 25000, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Overdue", contactPerson: "Rajesh Sharma", phoneNo: "9876543210", email: "sharma@suppliers.com", panNo: "AAACS1234F", gstNo: "07AAACS1234F1Z" },
  { id: 2, sNo: 2, vendorName: "Tech Solutions Pvt Ltd", vendorCode: "VEN002", invoiceNo: "INV-102", invoiceDate: "10-04-2026", dueDate: "10-05-2026", billAmount: 75000, paidAmount: 75000, outstandingAmount: 0, age0to30: 0, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Settled", contactPerson: "Amit Kumar", phoneNo: "9876543211", email: "amit@techsol.com", panNo: "AABCT5678G", gstNo: "07AABCT5678G1Z" },
  { id: 3, sNo: 3, vendorName: "Goyal Transport Co", vendorCode: "VEN003", invoiceNo: "INV-103", invoiceDate: "01-01-2026", dueDate: "01-02-2026", billAmount: 35000, paidAmount: 0, outstandingAmount: 35000, age0to30: 0, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 35000, age365Plus: 0, status: "Critical", contactPerson: "Suresh Goyal", phoneNo: "9876543212", email: "suresh@goyal.com", panNo: "AAADG9012H", gstNo: "07AAADG9012H1Z" },
  { id: 4, sNo: 4, vendorName: "Singh Enterprises", vendorCode: "VEN004", invoiceNo: "INV-104", invoiceDate: "20-02-2026", dueDate: "20-03-2026", billAmount: 25000, paidAmount: 25000, outstandingAmount: 0, age0to30: 0, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Settled", contactPerson: "Harpreet Singh", phoneNo: "9876543213", email: "harpreet@singh.com", panNo: "AAAFS3456J", gstNo: "07AAAFS3456J1Z" },
  { id: 5, sNo: 5, vendorName: "Patel Agencies", vendorCode: "VEN005", invoiceNo: "INV-105", invoiceDate: "05-05-2026", dueDate: "05-06-2026", billAmount: 60000, paidAmount: 20000, outstandingAmount: 40000, age0to30: 40000, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Current", contactPerson: "Kiran Patel", phoneNo: "9876543214", email: "kiran@patel.com", panNo: "AAAGP7890K", gstNo: "07AAAGP7890K1Z" },
  { id: 6, sNo: 6, vendorName: "Verma Logistics", vendorCode: "VEN006", invoiceNo: "INV-106", invoiceDate: "15-12-2025", dueDate: "15-01-2026", billAmount: 45000, paidAmount: 45000, outstandingAmount: 0, age0to30: 0, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Settled", contactPerson: "Rakesh Verma", phoneNo: "9876543215", email: "rakesh@verma.com", panNo: "AAAHV1234L", gstNo: "07AAAHV1234L1Z" },
  { id: 7, sNo: 7, vendorName: "Malhotra & Sons", vendorCode: "VEN007", invoiceNo: "INV-107", invoiceDate: "10-03-2026", dueDate: "10-04-2026", billAmount: 85000, paidAmount: 0, outstandingAmount: 85000, age0to30: 0, age31to60: 85000, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Overdue", contactPerson: "Vikram Malhotra", phoneNo: "9876543216", email: "vikram@malhotra.com", panNo: "AAAFM5678M", gstNo: "07AAAFM5678M1Z" },
  { id: 8, sNo: 8, vendorName: "Gupta Traders", vendorCode: "VEN008", invoiceNo: "INV-108", invoiceDate: "25-04-2026", dueDate: "25-05-2026", billAmount: 22000, paidAmount: 22000, outstandingAmount: 0, age0to30: 0, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Settled", contactPerson: "Neha Gupta", phoneNo: "9876543217", email: "neha@gupta.com", panNo: "AAAFG9012N", gstNo: "07AAAFG9012N1Z" },
  { id: 9, sNo: 9, vendorName: "Kumar Electricals", vendorCode: "VEN009", invoiceNo: "INV-109", invoiceDate: "01-03-2026", dueDate: "31-03-2026", billAmount: 18000, paidAmount: 5000, outstandingAmount: 13000, age0to30: 0, age31to60: 13000, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Overdue", contactPerson: "Sunil Kumar", phoneNo: "9876543218", email: "sunil@kumar.com", panNo: "AAAFK3456P", gstNo: "07AAAFK3456P1Z" },
  { id: 10, sNo: 10, vendorName: "Sharma Suppliers", vendorCode: "VEN001", invoiceNo: "INV-110", invoiceDate: "18-05-2026", dueDate: "18-06-2026", billAmount: 32000, paidAmount: 0, outstandingAmount: 32000, age0to30: 32000, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Current", contactPerson: "Rajesh Sharma", phoneNo: "9876543210", email: "sharma@suppliers.com", panNo: "AAACS1234F", gstNo: "07AAACS1234F1Z" },
  { id: 11, sNo: 11, vendorName: "Goyal Transport Co", vendorCode: "VEN003", invoiceNo: "INV-111", invoiceDate: "15-08-2025", dueDate: "15-09-2025", billAmount: 28000, paidAmount: 0, outstandingAmount: 28000, age0to30: 0, age31to60: 0, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 28000, status: "Critical", contactPerson: "Suresh Goyal", phoneNo: "9876543212", email: "suresh@goyal.com", panNo: "AAADG9012H", gstNo: "07AAADG9012H1Z" },
  { id: 12, sNo: 12, vendorName: "Patel Agencies", vendorCode: "VEN005", invoiceNo: "INV-112", invoiceDate: "10-02-2026", dueDate: "10-03-2026", billAmount: 55000, paidAmount: 30000, outstandingAmount: 25000, age0to30: 0, age31to60: 25000, age61to90: 0, age91to180: 0, age181to365: 0, age365Plus: 0, status: "Overdue", contactPerson: "Kiran Patel", phoneNo: "9876543214", email: "kiran@patel.com", panNo: "AAAGP7890K", gstNo: "07AAAGP7890K1Z" },
];
...
export default function VendorOutstandingAgeingReportNew() {
  // Date state
  ...
  // Sort state
  const [sortColumn, setSortColumn] = useState<keyof VendorOutstandingNew>("sNo");
  const [sortDirection, setSortDirection] = useState<"asc" | "desc">("asc");

  // Filtered data
  const [filteredData, setFilteredData] = useState<VendorOutstandingNew[]>(mockVendorOutstandingNewData);
  ...
  const [mailSubject, setMailSubject] = useState("Vendor Outstanding Ageing Report NEW");
  const [mailBody, setMailBody] = useState(
    "Dear Sir/Madam,\n\nPlease find attached the Vendor Outstanding Ageing Report NEW.\n\nRegards,\nFinance Team"
  );

  // Handle Show Report / Grid View
  const handleGridView = () => {
    let filtered = [...mockVendorOutstandingNewData];
  ...
  const handleClear = () => {
    ...
    setSelectedBranch("");
    setSelectedVendor("");
    setFilteredData(mockVendorOutstandingNewData);
    setSortColumn("sNo");
  ...
  // Handle Sort
  const handleSort = (column: keyof VendorOutstandingNew) => {
  ...
  // Get sort icon
  const getSortIcon = (column: keyof VendorOutstandingNew) => {
  ...
  const generateReportHTML = (): string => {
    ...
    return `
      ...
      <head>
        <meta charset="UTF-8">
        <title>Vendor Outstanding Ageing Report NEW</title>
        <style>
      ...
      <body>
        <div class="header">
          <h2>📊 VENDOR OUTSTANDING AGEING REPORT NEW</h2>
        ...
        <table>
          <thead>
            ...
            <th>Due Date</th><th>Bill Amt</th><th>Paid Amt</th><th>Outstanding</th>
            <th>0-30</th><th>31-60</th><th>61-90</th><th>91-180</th><th>181-365</th><th>365+</th><th>Status</th>
            </tr>
          </thead>
  ...
  const handleSendEmail = () => {
    ...
    const file = new File([blob], `Vendor_Ageing_Report_New_${format(new Date(), "yyyyMMdd_HHmmss")}.html`, { type: "text/html" });
  ...
  const handleDiscardEmail = () => {
    setMailModalOpen(false);
    setMailTo("");
    setMailSubject("Vendor Outstanding Ageing Report NEW");
  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <div className="border-b pb-4">
        <h1 className="text-2xl font-bold text-primary">VENDOR OUTSTANDING AGEING REPORT NEW</h1>
        ...
        <Card>
          <CardHeader className="bg-gray-50">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Vendor Outstanding Ageing Report NEW
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-100 sticky top-0">
                <tr>
                  ...
                  <th className="p-2 text-right font-semibold border-b bg-green-50">0-30 Days</th>
                  <th className="p-2 text-right font-semibold border-b bg-yellow-50">31-60 Days</th>
                  <th className="p-2 text-right font-semibold border-b bg-orange-50">61-90 Days</th>
                ...
                {filteredData.length === 0 ? (
                  ...
                  filteredData.map((record) => (
                    <tr key={record.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-2 text-right font-bold text-red-600">₹{record.outstandingAmount.toLocaleString("en-IN")}</td>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="bg-gray-50 p-3 rounded-md text-sm text-gray-600">
              <strong>Attachment:</strong> Vendor_Ageing_Report_New_{format(new Date(), "yyyyMMdd")}.html
            </div>
          </div>
